...
# Параметр fisrtName состоит из английские буквы
def test_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("QWErty")


# Тест 6. Успешное создание пользователя
# Параметр fisrtName состоит из русские буквы
def test_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("Мария")


# Тест 7. Неудачное создание пользователя
# Параметр fisrtName имеет внутри пробелы
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Человек и Ко")


# Тест 8. Неудачное создание пользователя
# Параметр fisrtName имеет внутри спецсимволы
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("№%@")

# Тест 9. Неудачное создание пользователя
# Параметр fisrtName имеет внутри спецсимволы
def test_create_user_has_number_in_first_name_get_error_response():
    negative_assert_symbol("123")

# Тест 10. Неудачное создание пользователя
# Параметр fisrtName отсутствует в теле запроса
def test_create_user_no_first_name_get_error_response():
    user_body = data.user_body.copy()
    user_body.pop("firstName")
    negative_assert_no_first_name(user_body)

# Тест 11. Неудачное создание пользователя
# Параметр fisrtName пустое в теле запроса
def test_create_user_empty_first_name_get_error_response():
    user_body = get_user_body("")
    negative_assert_no_first_name(user_body)

# Тест 12. Неудачное создание пользователя
# В параметр fisrtName передан другой тип данных
